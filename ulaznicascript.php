...
<body>
    ...
    <body>
        ...
        <?php
        $broj_reda = $_POST['broj_reda'];
        $broj_mesta = $_POST['broj_mesta'];
        $tip_mesta = $_POST['tip_mesta'];
        $izvođač = $_POST['izvođač'];
        ...
        $sql = "INSERT INTO ulaznica (broj_reda, broj_mesta, tip_mesta, izvođač) VALUES ('$broj_reda','$broj_mesta','$tip_mesta','$izvođač')";
        $exc = $con->query($sql);
